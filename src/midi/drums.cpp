...
#include "midi/drums.hpp"             /* midi::drum_name(), etc.            */
#include "midi/midibytes.hpp"         /* midi::c_byte_data_max              */
...
{
    bool result { drumnumber < int(c_byte_data_max) };
    if (result)
    {
 ...
 * c_gm_drum_names [c_byte_data_max] =
 */
