...
#include "midi/controllers.hpp"         /* midi::controller_name(), etc.    */
#include "midi/midibytes.hpp"           /* midi::byte type                  */
...
static namepair
s_controller_names [c_byte_data_max] =
{
    {   0, "Bank Select"                          },    // 0x00
    {   1, "Modulation Wheel"                     },
    {   2, "Breath controller"                    },
...
{
    std::string result;
    if (index >= 0 && index < c_byte_data_max)
    {
