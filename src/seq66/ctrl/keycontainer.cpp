...
/**
 *  This function was added in order to be able to get the keystroke from the
 *  mute-group in order to try to display that the mute-group learn worked
 *  via MIDI control.
 */
...
{
    static lib66::tokenization s_keys_pattern
    {
        "1", /*  0 */ "q", /*  1 */ "a", /*  2 */ "z", /*  3 */
        "2", /*  4 */ "w", /*  5 */ "s", /*  6 */ "x", /*  7 */
        "3", /*  8 */ "e", /*  9 */ "d", /* 10 */ "c", /* 11 */
    ...
    static lib66::tokenization s_keys_mute_group
    {
        "!", /*  0 */ "Q", /*  1 */ "A", /*  2 */ "Z", /*  3 */
        "@", /*  4 */ "W", /*  5 */ "S", /*  6 */ "X", /*  7 */
        "#", /*  8 */ "E", /*  9 */ "D", /* 10 */ "C", /* 11 */
