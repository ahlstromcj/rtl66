#if ! defined RTL66_AUTOMATION_HPP
#define RTL66_AUTOMATION_HPP
 ...
 *  controllable without a graphical user interface.  See the cpp file for
 *  additional information.  This module requires C++11 and above.
 */
 ...
 *  correspond to the MIDI Controls for UI (user-interface) actions; see the
 *  uiactions enumeration. This enumeration cannot be a class enumeration,
 *  because enum classes cannot be used as array indices.
 */
...
#if defined RTL66_USE_SLOT_STRING_CONVERSIONS
