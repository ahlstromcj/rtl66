#ifndef RTL66_MIDICONTROLOUT_HPP
#define RTL66_MIDICONTROLOUT_HPP
...
private:
    ...
    using actiontriplet = struct
    {
        ...
        midi::event att_action_event_on;
        midi::event att_action_event_off;
        midi::event att_action_event_del;       /* inactive, show as dark   */
    };
...
public:
    ...
    midi::event get_seq_event (int seq, seqaction what) const;
    ...
    std::string get_event_str (const midi::event & ev) const;
    ...
    bool add_macro (const lib66::tokenization & tokens)
    {
    ...
    lib66::tokenization macro_names () const
    {
        return m_macro_events.names();
    }

    midi::bytes macro_bytes (const std::string & name) const
    {
...
#endif      // RTL66_MIDICONTROLOUT_HPP
