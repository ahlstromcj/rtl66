#if ! defined RTL66_PLAYLIST_HPP
#define RTL66_PLAYLIST_HPP
...
public:
    ...
    bool select_list_by_midi (int ctl, bool selectsong = false);
    ...
    bool select_song_by_midi (int ctl);
    bool next_song ();
    bool previous_song ();
    ...
    bool open_select_song_by_midi (int ctl, bool opensong = true);
    ...
    bool open_select_list_by_midi (int ctl, bool opensong = true);
...
private:
    ...
    bool do_ctrl_lookup (int ctl)
    {
        return ctl == (-1);
    }

    bool ctrl_is_valid (int ctl)
    {
        return (ctl >= 0 && ctl < 128) || do_ctrl_lookup(ctl);
    }
