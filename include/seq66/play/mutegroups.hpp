#if ! defined RTL66_MUTEGROUPS_HPP
#define RTL66_MUTEGROUPS_HPP
...
public:
     ...
     *  number.  Remember that a mutegroup object has a 2-D vector of
     *  midi::bools, with a given number of rows and columns, along with the
     *  group number and the number of patterns in the group.
     */
...
private:
     ...
     *  that set.  The value of -1 (RTL66_NO_MUTE_GROUP_SELECTED) to indicate
...
public:
    ...
    bool apply (mutegroup::number group, midi::booleans & bits);
    bool unapply (mutegroup::number group, midi::booleans & bits);
    bool toggle (mutegroup::number group, midi::booleans & bits);
    bool toggle_active (mutegroup::number group, midi::booleans & armedbits);
    ...
    bool group_save (bool midifile, bool mutesfile);
    ...
    bool group_load (bool midifile, bool mutesfile);
    std::string group_load_label () const;
    bool load_mute_groups (bool midis, bool mutes);
    ...
    bool load (mutegroup::number gmute, const midi::booleans & bits);
    bool set (mutegroup::number gmute, const midi::booleans & bits);
    midi::booleans get (mutegroup::number gmute) const;
...
public:         // setters that need to be public
    ...
    bool update (mutegroup::number gmute, const midi::booleans & bits);
