#if ! defined RTL66_SCREENSET_HPP
#define RTL66_SCREENSET_HPP
...
private:
    ...
    void song_recording_start (midi::pulse current_tick, bool snap = true);
    void song_recording_stop (midi::pulse current_tick);
    void clear_snapshot ();
    void save_snapshot ();
    ...
    (
        ...
        midi::pulse tick_start, midi::pulse tick_finish
    );
    bool move_triggers
    (
    ...
    bool apply_bits (const midi::booleans & mg);
    bool learn_bits (midi::booleans & mg);
