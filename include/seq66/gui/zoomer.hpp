#if ! defined RTL66_SEQ66_ZOOMER_HPP
#define RTL66_SEQ66_ZOOMER_HPP
...
#include "midi/midibytes.hpp"           /* midi::pulse, etc.                */
...
public:
    ...
    midi::pulse pix_to_tix (int x) const;
    int tix_to_pix (midi::pulse ticks) const;

    int xoffset (midi::pulse tick) const
    {
...
extern const lib66::tokenization & zoom_items ();
extern int zoom_item (int i);
extern const lib66::tokenization & expanded_zoom_items ();
extern int expanded_zoom_item (int i);

}           // namespace seq66

#endif      // RTL66_SEQ66_ZOOMER_HPP
